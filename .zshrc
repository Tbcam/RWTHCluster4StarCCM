...
alias sl="squeue -t all -u pa110240 -o \"%9i %.40j %.9T %.20S %.20e %.6M %.9l %.16p %.4C %.4D %30Y %a %.R\""
alias w1sl='watch -n1 "squeue -t all -u pa110240 -o \"%9i %.40j %.9T %.20S %.20e %.6M %.9l %.16p %.4C %.4D %30Y %a %.R\""'
alias go2dir="cd /rwthfs/rz/cluster/hpcwork/pa110240"
alias go2gpu="cd /rwthfs/rz/cluster/hpcwork/pa110240/GPUST"
alias go2cpu="cd /rwthfs/rz/cluster/hpcwork/pa110240/CPUST"
